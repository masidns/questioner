...
(function($, window, document, undefined) {
	...
	$.extend(SmartWizard.prototype, {
		...
		_setToolbar: function() {
			...
			var btnNext =
				this.options.toolbarSettings.showNextButton !== false
					...
					: null;
			var btnFinish =
				this.options.toolbarSettings.showFinishButton !== false
					? $('<button></button>')
							.text(this.options.lang.finish)
							.addClass('btn btn-success sw-btn-finish')
							.attr({ type: 'button', hidden: 'true', 'data-toggle': 'modal', 'data-target': '#confirm' })
					: null;
			var btnPrevious =
			...
			var btnGroup = $('<div></div>')
				...
				.attr('role', 'group')
				.append(btnPrevious, btnNext, btnFinish);
		...
		_loadStepContent: function(idx) {
			...
			if (
				this.current_index !== null &&
				this._triggerEvent('leaveStep', [ curTab, this.current_index, stepDirection ]) === false
			) {
				return false;
			}
		...
		_fixHeight: function(idx) {
			...
			if (this.options.autoAdjustHeight) {
				...
				this.container
					.finish()
					.animate({ minHeight: selPage.outerHeight() }, this.options.transitionSpeed, function() {});
			}
			return true;
		},

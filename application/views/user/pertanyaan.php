            ...
            <div ng-repeat="layanan in datas.layanan" id="step-{{$index+1}}">
                <div id="accordion">
                    <div class="card" ng-repeat="itemaspek in layanan.pertanyaan">
                        <div class="card-header" id="heading{{itemaspek.id_aspek}}">
                            <h5 class="mb-0">
                                <button ng-class="{'btn btn-link': $index==0, 'btn btn-link collapsed': $index !==0}"
                                    ...
                                    data-target="#collapse{{itemaspek.id_aspek}}{{layanan.id_layanan}}"
                                    aria-expanded="true"
                        ...
                        <div id="collapse{{itemaspek.id_aspek}}{{layanan.id_layanan}}"
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr ng-repeat="itempertanyaan in itemaspek.dataaspek">
                                            ...
                                            <td class="text-center align-middle">
                                                <div
                                                    class="form-check form-check-inline  d-flex justify-content-between ml-4">
                                                    <div class="custom-control custom-radio"
                                                        ng-repeat="range in datas.rangenilai">
                                                        <input class="custom-control-input" type="radio"
                                                            ...
                                                            ng-model="itempertanyaan.checked"
                                                            ng-change="model.id_periode=periode.id_periode;model.id_range=range.id_range;model.id_grup = itempertanyaan.id_grup; addItem()"
                                                            value="{{range.id_range}}">
                                                        <label
